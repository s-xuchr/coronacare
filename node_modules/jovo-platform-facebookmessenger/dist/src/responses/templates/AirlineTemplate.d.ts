...
export declare function stringifyFacebookDate(date: Date): string;
export declare type AirlineTemplateOptions = Omit<AirlineTemplatePayload, 'template_type'>;
...
export declare class AirlineTemplate extends Template<AirlineTemplatePayload> {
}
