...
export declare type GenericTemplateOptions = Omit<GenericTemplatePayload, 'template_type'>;
...
export declare class GenericTemplate extends Template<GenericTemplatePayload> {
}
